...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it 'Should be invalid if name password is nill' do
      @user = User.new(name: 'test', email: 'test@gmail.com', password: nil, password_confirmation: '12345678')
      
      expect(@user).to_not be_valid
    end

    it 'Should be invalid if name password_confirmation is nill' do
      @user = User.new(name: 'test', email: 'test@gmail.com', password: '12345678', password_confirmation: nil)
      
      expect(@user).to_not be_valid
    end

    it 'Should be invalid if name password doesn\'t equal password_confirmation' do
      @user = User.new(name: 'test', email: 'test@gmail.com', password: '12345678', password_confirmation: "1234567891")
    ...
    it 'Should be invalid if name password is less than 8 characters' do
      @user = User.new(name: 'test', email: 'test@gmail.com', password: '1234567', password_confirmation: "1234567")
    ...
    it "Should be invalid if email already exists in the database" do
      ...
      user2 = User.new(name: 'test', email: 'test@gmail.com', password: '12345678', password_confirmation: "12345678")
      user2.save
  ...
  describe 'authenticate_with_credentials' do
    it 'should login when valid credentials are passed' do
      user = User.new(name: 'test_name', email: 'test@gmail.com', password: '12345678', password_confirmation: '12345678')
      user.save
